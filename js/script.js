...
const spinIn = document.querySelector('#spinIn');

function meses(ano2022){
    ...
    new Chart(graphicBar, {
      ...
      data: {
        ...
        datasets: [{
          label: 'R$',
          data: {
            'Jan 2022': ano2022.api[0].VALOR , 
            'Fer 2022': ano2022.api[1].VALOR ,
            'Mar 2022': ano2022.api[2].VALOR ,
            'Abr 2022': ano2022.api[3].VALOR ,
            'Mai 2022': ano2022.api[4].VALOR ,
            'Jun 2022': ano2022.api[5].VALOR ,
            'Jul 2022': ano2022.api[6].VALOR ,
            'Ago 2022': ano2022.api[7].VALOR ,
            'Set 2022': ano2022.api[8].VALOR ,
            'Out 2022': ano2022.api[9].VALOR ,
            'Nov 2022': ano2022.api[10].VALOR ,
            'Dez 2022': ano2022.api[11].VALOR 
...
async function api(){
  ...
  const ano2022 = await fetch('https://script.googleusercontent.com/macros/echo?user_content_key=8sHwDIHnYRVCs5BdbUBmr9nOgpVuyWAj8WMkmdUwi6P5x7mmNvMFHO4Omrf6StvnlT_kd5ysu5ahERnSfVIUQnPSJCpsOKcVm5_BxDlH2jW0nuo2oDemN9CCS2h10ox_1xSncGQajx_ryfhECjZEnFVXWXR0nSELR97zGgQBms-7dZnT2diY5rajuaka_Z0rKkB6hHYVkl7PctLAiJohTZfdx3kKMqce8bLhRpGbczYtqRaF3dzGGA&lib=M8G5hm_VlBnB5nuEPbx8Vg6frgnVbBec2').then(response => response.json());
