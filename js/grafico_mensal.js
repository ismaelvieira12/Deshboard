...
// // para pegar os dados de todas as paginas em paralelo
...
//         const allPgaesData = await Promise.all(pagePromises);
//         const allData = allPgaesData.flatMap(page => page.data);

//         return allData;
//     }catch(error){
//         throw new Error("Erro ao buscar todas as páginas", error.mensage);
//     }
// }
